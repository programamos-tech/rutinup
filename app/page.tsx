...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      {/* Header */}
      <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-white/10 transition-all duration-300 ${
        scrolled ? 'bg-dark-900/80 shadow-lg' : 'bg-dark-900/30'
      }`}>
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <div className="animate-fade-in-left">
              ...
              <p className="hidden sm:block text-gray-500 font-medium -mt-1 leading-tight" style={{ fontSize: 'calc(1.875rem * 0.28)' }}>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              <div className="inline-block mb-4 sm:mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-primary-500/20 border border-primary-500/50 rounded-full text-primary-400 text-xs sm:text-sm font-medium inline-flex items-center gap-1.5 sm:gap-2">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-50 leading-tight mb-4 sm:mb-6 animate-fade-in-up px-4" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed animate-fade-in-up px-4" style={{ animationDelay: '0.6s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-400 mt-4 sm:mt-6 animate-fade-in-up flex flex-wrap items-center justify-center gap-1 sm:gap-2 px-4" style={{ animationDelay: '1s' }}>
      ...
      <section id="features" className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-50 mb-3 sm:mb-4 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-16">
            <div className="p-6 sm:p-8 scroll-animate">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-gray-50 mb-2 sm:mb-3 text-center">Gestión de Miembros</h4>
            ...
            <div className="p-6 sm:p-8 scroll-animate">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-gray-50 mb-2 sm:mb-3 text-center">Control de Clases</h4>
              <p className="text-sm sm:text-base text-gray-400 leading-relaxed text-center">
            ...
            <div className="p-6 sm:p-8 scroll-animate">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-gray-50 mb-2 sm:mb-3 text-center">Finanzas y Reportes</h4>
              <p className="text-sm sm:text-base text-gray-400 leading-relaxed text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6">
              ...
              <div>
                <h5 className="font-semibold text-gray-50 mb-1 text-sm sm:text-base">Rápido y Simple</h5>
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6">
              ...
              <div>
                <h5 className="font-semibold text-gray-50 mb-1 text-sm sm:text-base">Seguro y Confiable</h5>
                <p className="text-xs sm:text-sm text-gray-400">Tus datos protegidos con los más altos estándares</p>
              </div>
            </div>
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6">
              <TrendingUp className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" />
              <div>
                <h5 className="font-semibold text-gray-50 mb-1 text-sm sm:text-base">Escalable</h5>
                <p className="text-xs sm:text-sm text-gray-400">Crece con tu negocio sin límites</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 bg-dark-800/20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div 
              ...
              className="bg-dark-800/50 p-6 sm:p-8 rounded-xl border-2 border-accent-500/50 hover:border-accent-500 hover:shadow-lg hover:shadow-accent-500/30 hover:-translate-y-1 transition-all duration-300 relative flex flex-col scroll-animate cursor-pointer"
            >
              ...
              <div className="mb-6 pt-2">
                <div className="inline-block px-3 py-1 bg-accent-500/20 border border-accent-500/50 rounded-full mb-3 sm:mb-4">
                  <span className="text-accent-400 text-xs sm:text-sm font-medium">OFERTA FUNDADORES</span>
                </div>
                ...
                <div className="bg-accent-500/10 border border-accent-500/30 rounded-lg p-2.5 sm:p-3 mb-3 sm:mb-4">
                  <p className="text-accent-400 text-xs font-medium flex items-center gap-1.5 sm:gap-2">
              ...
              <ul className="space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 flex-1">
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Miembros ilimitados</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Gestión de membresías</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Control de clases</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Cobros inteligentes</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Métricas en tiempo real</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-accent-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Soporte prioritario</span>
                </li>
              </ul>

              <div className="pt-4 sm:pt-6 border-t border-dark-700/50 mt-auto">
                <div className="mb-2">
                  <span className="text-gray-400 line-through text-lg sm:text-xl">$79.000</span>
                </div>
                <div className="mb-4 sm:mb-6">
                  <span className="text-3xl sm:text-4xl font-bold text-accent-400">$59.000</span>
                  <span className="text-gray-400 ml-2 text-sm sm:text-base">COP / mes</span>
                </div>
            ...
            <div 
              ...
              className="bg-dark-800/50 p-6 sm:p-8 rounded-xl border-2 border-primary-500/50 hover:border-primary-500 hover:shadow-lg hover:shadow-primary-500/30 hover:-translate-y-1 transition-all duration-300 relative flex flex-col scroll-animate cursor-pointer"
            >
              <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
              ...
              <div className="mb-6 pt-2">
                <div className="inline-block px-3 py-1 bg-primary-500/20 border border-primary-500/50 rounded-full mb-3 sm:mb-4">
                  <span className="text-primary-400 text-xs sm:text-sm font-medium">PLAN MENSUAL</span>
                </div>
                <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">
                  Precio normal
                </p>
                <div className="bg-primary-500/10 border border-primary-500/30 rounded-lg p-2.5 sm:p-3 mb-3 sm:mb-4">
                  <p className="text-primary-400 text-xs font-medium flex items-center gap-1.5 sm:gap-2">
              ...
              <ul className="space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 flex-1">
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-primary-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Miembros ilimitados</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-primary-400 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-primary-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Soporte por WhatsApp</span>
                </li>
              </ul>
              ...
              <div className="pt-4 sm:pt-6 border-t border-dark-700/50 mt-auto">
                ...
                <div className="mb-4 sm:mb-6">
                  <span className="text-3xl sm:text-4xl font-bold text-gray-50">$79.000</span>
                  <span className="text-gray-400 ml-2 text-sm sm:text-base">COP / mes</span>
                </div>
            ...
            <div 
              ...
              className="bg-dark-800/50 p-6 sm:p-8 rounded-xl border border-success-500/50 hover:border-success-500 hover:shadow-lg hover:shadow-success-500/20 hover:-translate-y-1 transition-all duration-300 flex flex-col scroll-animate cursor-pointer"
            >
              <div className="mb-6">
                <div className="inline-block px-3 py-1 bg-success-500/20 border border-success-500/50 rounded-full mb-3 sm:mb-4">
                  <span className="text-success-400 text-xs sm:text-sm font-medium">PLAN ANUAL</span>
                </div>
                <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">
                  Ahorra 10% pagando anual
                </p>
                <div className="bg-success-500/10 border border-success-500/30 rounded-lg p-2.5 sm:p-3 mb-3 sm:mb-4">
                  <p className="text-success-400 text-xs font-medium flex items-center gap-1.5 sm:gap-2">
              ...
              <ul className="space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 flex-1">
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-success-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-gray-300">Miembros ilimitados</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-success-400 flex-shrink-0 mt-0.5" />
              ...
              <div className="pt-4 sm:pt-6 border-t border-dark-700/50 mt-auto">
                <div className="mb-2">
                  <span className="text-gray-400 line-through text-lg sm:text-xl">$948.000</span>
                  <span className="text-success-400 text-xs sm:text-sm ml-2 font-medium">(-10%)</span>
                </div>
                <div className="mb-2">
                  <span className="text-3xl sm:text-4xl font-bold text-gray-50">$854.400</span>
                  <span className="text-gray-400 ml-2 text-sm sm:text-base">COP / año</span>
                </div>
                <div className="mb-4 sm:mb-6">
                  <span className="text-xs sm:text-sm text-gray-400">Equivale a $71.200/mes</span>
                </div>
                <Button variant="primary" className="w-full text-sm sm:text-base">
                  Pagar anual
                </Button>
          ...
          <div className="mt-6 sm:mt-8 text-center px-4">
            <p className="text-xs sm:text-sm text-gray-400 flex flex-wrap items-center justify-center gap-1.5 sm:gap-2">
              <CheckCircle className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-success-400 flex-shrink-0" />
      ...
      {/* Footer */}
      <footer className="bg-dark-800/50 border-t border-dark-700/50 mt-12 sm:mt-16 md:mt-20">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div className="sm:col-span-2 md:col-span-1">
              ...
              <div className="flex gap-2 sm:gap-3">
                <a href="#" className="w-8 h-8 bg-dark-700/50 rounded-lg flex items-center justify-center hover:bg-primary-500/20 transition-colors">
            ...
            {/* Product */}
            <div>
              <h5 className="font-semibold text-gray-50 mb-3 sm:mb-4 text-sm sm:text-base">Producto</h5>
            ...
            {/* Company */}
            <div>
              <h5 className="font-semibold text-gray-50 mb-3 sm:mb-4 text-sm sm:text-base">Empresa</h5>
              <ul className="space-y-1.5 sm:space-y-2">
                <li>
            ...
            {/* Legal */}
            <div>
              <h5 className="font-semibold text-gray-50 mb-3 sm:mb-4 text-sm sm:text-base">Legal</h5>
              <ul className="space-y-1.5 sm:space-y-2">
                <li>
          ...
          {/* Contact Info */}
          <div className="pt-6 sm:pt-8 border-t border-dark-700/50">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm text-gray-400 justify-center md:justify-start">
                <div className="flex items-center gap-1.5 sm:gap-2 justify-center">
                  <Mail className="w-3.5 sm:w-4 h-3.5 sm:h-4 flex-shrink-0" />
                  <a href="mailto:programamos.st@gmail.com" className="hover:text-primary-400 transition-colors break-all">
                    programamos.st@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2 justify-center">
                  <Phone className="w-3.5 sm:w-4 h-3.5 sm:h-4 flex-shrink-0" />
                  <a href="https://wa.me/573002061711" target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition-colors">
                    300 206 1711
                  </a>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2 justify-center">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-2 sm:gap-4">
              ...
              <p className="text-xs sm:text-sm text-gray-500 text-center md:text-right">
                ...
                <a href="mailto:programamos.st@gmail.com" className="text-primary-400 hover:text-primary-300 transition-colors">
                  programamos.st
                </a>
                {' '}•{' '}
                <a href="mailto:programamos.st@gmail.com" className="text-primary-400 hover:text-primary-300 transition-colors">
