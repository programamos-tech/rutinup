-- Fix registration function to also populate the cache table
-- The cache table needs to be populated when a user is created during registration

-- Update the create_gym_and_user function to also insert into cache
...
BEGIN
  ...
  BEGIN
    ...
    -- IMPORTANT: Also populate the cache table immediately
    -- The trigger should handle this, but we do it explicitly to ensure it happens
